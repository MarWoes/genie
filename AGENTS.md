...
Never commit anything to git. Only user-reviewed code is allowed in the repository.

# General FastAPI Best Practices for AI Agents

A machine-readable companion for AI coding agents
